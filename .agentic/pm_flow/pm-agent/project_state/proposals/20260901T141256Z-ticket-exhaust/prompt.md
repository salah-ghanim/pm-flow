...
`ticket-exhaust`. Decide whether it deserves a section of this product, and
...
- .agentic/pm_flow/pm-agent/project_state/proposals/20260901T141256Z-ticket-exhaust/request.md

Paths already owned by live sections, which this section may not claim:

- `template/.agentic/pm_flow/schemas/**` (boundary-schema)
- `template/.agentic/pm_flow/export.py` (boundary-schema)
- `template/.agentic/pm_flow/pm_flow.sh` (boundary-schema)
- `template/.agentic/pm_flow/topology.py` (boundary-schema)
- `template/.agentic/pm_flow/agent_exec.sh` (boundary-schema)
- `tests/boundary_schema_test.sh` (boundary-schema)
- `tests/fixtures/boundary_schema/**` (boundary-schema)
- `template/.agentic/pm_flow/telemetry.py` (outcome-record)
- `template/.agentic/pm_flow/driver.zsh` (outcome-record)
- `src/pm_flow/semconv.py` (outcome-record)
- `tests/otel_semconv_test.sh` (outcome-record)
- `tests/outcome_record_test.sh` (outcome-record)
- `tests/fixtures/outcome_record/**` (outcome-record)
- `template/.agentic/pm_flow/inbox.zsh` (plan-inbox)
- `tests/plan_inbox_test.sh` (plan-inbox)
- `tests/fixtures/plan_inbox/**` (plan-inbox)
- `install.sh` (real-install)
- `tests/real_install_test.sh` (real-install)
- `tests/fixtures/real_install/**` (real-install)
- `docs/real-install.md` (real-install)
- `README.md` (real-install)
