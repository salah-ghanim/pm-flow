...
| knowledge-handover | must-have | planned | Section created; its PM sub-agent has not been launched yet. | [handoff](../sections/knowledge-handover/handoff.md) | `.agentic/pm_flow/pm-agent/runs/20260906T105831Z-knowledge-handover-4d6826b4` | 2026-09-06T10:58:31Z |
...
| real-install | must-have | blocked | Blocked on an external dependency: A2–A5 need a run against `/Users/salah/code/personal/golden-grid`, which no session in this loop can reach (probe above); unblocked by either a session whose allo... | [handoff](../sections/real-install/handoff.md) | `.agentic/pm_flow/pm-agent/runs/20260825T093747Z-real-install-506900f5` | 2026-09-01T20:41:18Z |
