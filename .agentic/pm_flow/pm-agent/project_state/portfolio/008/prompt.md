...
project spent $61.0681 across 50 dispatch(es) and
15 section cycle(s); 17 section(s) are done.
...
- .agentic/pm_flow/pm-agent/project_state/portfolio/008/facts.md
- .agentic/pm_flow/pm-agent/sections/knowledge-handover/handoff.md
- .agentic/pm_flow/pm-agent/sections/plan-inbox/handoff.md
- .agentic/pm_flow/pm-agent/sections/real-install/handoff.md
- .agentic/pm_flow/pm-agent/sections/ticket-exhaust/handoff.md
- .agentic/pm_flow/pm-agent/sections/workflow-studio/handoff.md
